...
define('PATH_TO_THUMBS', isset($_GET['path_to_thumbs']) ? $_GET['path_to_thumbs'] : './Thumbs/Android_Zone/');
define('PATH_TO_LOGS',   '');
...
private function _logic() {
	...
	$this->pathToImage = isset($_GET['file']) ? $_GET['file'] : '';
