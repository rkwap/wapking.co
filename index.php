...
$all = $all[0];
$all2 = mysql_fetch_row(mysql_query('SELECT COUNT(`id`) FROM `files` WHERE `infolder` = "'.$d['path'].'"'));
$all2 = $all2[0];
////////////////////
$pages = ceil($all/$onpage);
$pages2 = ceil($all2/$onpage2);
...
$sturl = "http://wapking.co/Category/";
...
echo '</title><link href="http://wapking.co/style.css" rel="stylesheet" style="text/css">
	...
	if(is_dir($file_info['path'])){
 	...
 	if (!empty($file_info['fastabout'])) $file_info['about'] = str_replace("\n", '<br>',$file_info['about']);
		...
		if($new_all[0] and $setup['day_new']!=0) 
                ...
                if (!$s['name']) {$new_all = '<img src="http://wapking.co/ext/updated.gif">';}
                else $new_all = '<img src="http://wapking.co/ext/new.gif">';
...
$uuurl = "http://wapking.co/Category/$file_info[id]";
...
$filenamedd = str_replace('(wapking.co)','',$filenamedd);
$filenamedd = str_replace('(wapking.co)','',$filenamedd);
$filenamedd = str_replace('-Funwap.ORG','',$filenamedd);

$urlhh = "http://wapking.co/Download/$file_info[id]";
$newUrl = $urlhh . "/$filenamedd.html";


///////////////////WallPapers///////////////////////////////////
if ($ext == 'gif' or $ext == 'jpeg' or $ext == 'jpg' or $ext == 'png' or $ext == 'JPG' or $ext == 'GIF' or $ext == 'PNG'or $ext == 'JPEG'){
$pre = '<a href="'.$newUrl.'"><img class="timg" src="http://wapking.co/thumber.php?img='.$file_info['path'].''.$file_info['ext'].'&h=100" height="70" width="60 alt="'.$file_info['name'].'.'.$ext.'"/></a>';}


if(file_exists("Thumbs/Wallpapers/$filename"))
{$pre = '<a href="'.$newUrl.'"><img class="timg" src="http://wapking.co/Thumbs/Wallpapers/'.$filename.'" height="70" width="60 alt="'.$file_info['name'].'.'.$ext.'"/></a>';}

//////////////////////Android Apps And Games //////////////////////////////////
if($ext == 'apk'){
$pre =  '<a href="'.$newUrl.'"><img  class="timg" src="/apk2.php?file=http://wapking.co/apk.php?lf='.$file_info['path'].'&id='.$file_info[id].'.jpg&h=100" height="70" width="60" alt="'.$file_info['name'].'.'.$ext.'"></a>';}

if(file_exists("Thumbs/Android_Zone/$filename.jpg"))

{$pre = '<a href="'.$newUrl.'"><img class="timg" src="http://wapking.co/Thumbs/Android_Zone/'.$filename.'.jpg" height="70" width="60 alt="'.$file_info['name'].'.'.$ext.'"/></a>';}
//////////////////////Iphone Apps And Games //////////////////////////////////

if($ext == 'ipa'){
$pre =  '<a href="'.$newUrl.'"><img  class="timg" src="/ipa2.php?file=http://wapking.co/ipa.php?lf='.$file_info['path'].'&id='.$file_info[id].'.jpg&h=100" height="70" width="60" alt="'.$file_info['name'].'.'.$ext.'"></a>';}
if(file_exists("Thumbs/IPhone_Zone/$filename.jpg"))
{$pre = '<a href="'.$newUrl.'"><img class="timg" src="http://wapking.co/Thumbs/IPhone_Zone/'.$filename.'.jpg" height="70" width="60 alt="'.$file_info['name'].'.'.$ext.'"/></a>';}

/////////////////////// Jar Files ///////////////////////////////////
if($ext == 'jar'){
$pre =  '<a href="'.$newUrl.'"><img  class="timg" src="/jar2.php?file=http://wapking.co/jar.php?lf='.$file_info['path'].'&id='.$file_info[id].'.jpg&h=100" height="70" width="60" alt="'.$file_info['name'].'.'.$ext.'"></a>';}

if(file_exists("Thumbs/Games/$filename.jpg"))
{$pre = '<a href="'.$newUrl.'"><img class="timg" src="http://wapking.co/Thumbs/Games/'.$filename.'.jpg" height="70" width="60 alt="'.$file_info['name'].'.'.$ext.'"/></a>';}
...
if ($ext == 'gif' or $ext == 'jpeg' or $ext == 'jpg' or $ext == 'png' or $ext == 'JPG' or $ext == 'GIF' or $ext == 'PNG'or $ext == 'JPEG' or $ext == 'nth' or $ext == 'thm' or $ext == 'jar' or $ext == 'apk' or $ext == 'ipa'){echo '</td><td>';}else{echo '';}      
       $file_info['name'] = str_replace('(wapking.co)','',$file_info['name']);
       $file_info['name'] = str_replace('(wapking.co)','',$file_info['name']);
