...
{
print '<strong>Song information:</strong><br>

Time: '.date('i:s', mktime(0,0,round($this->wave_length))).' min<br>';


if($title = trim($this->id3_title)){
print 'Name: '.iconv('windows-1251','UTF-8',$title).'<br>';
}
if($artist = trim($this->id3_artist)){
print 'Artist: '.iconv('windows-1251','UTF-8',$artist).'<br>';
}
if($album = trim($this->id3_album)){
print 'Album: '.iconv('windows-1251','UTF-8',$album).'<br>';
}
return;
}
